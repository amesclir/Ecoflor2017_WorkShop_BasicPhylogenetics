...
phyml.sylvia.GTRIG <- phymltest("sylvia.txt", exclude = c("JC69", "K80", "F81", "F84", "HKY85", "TN93", "GTR", "JC69+I", "K80+I", "F81+I", "F84+I", "HKY85+I", "TN93+I", "GTR+I", "JC69+G", "K80+G", "F81+G", "F84+G", "HKY85+G", "TN93+G", "GTR+G", "JC69+I+G", "K80+I+G", "F81+I+G", "F84+I+G", "HKY85+I+G", "TN93+I+G"), execname = "~/local/bin/PhyML-3.1/PhyML-3.1_linux64")
TRGTRIG <- read.tree("sylvia.txt_phyml_tree.txt")
...
#In case it works in your data set, you can use lines like these to plot the tree
...
#plot(raxml.sylvia.GTRCAT.boot, no.margin = TRUE)
#add.scale.bar(length = 0.01)
#setwd("/home/amesclir/Documents/Ubuntufiles/GITHUB/Ecoflor2017_WorkShop_BasicPhylogenetics")
...
add.scale.bar(length = 0.01)
write.tree(nj.est, "sylvia_ml_gtrig.tre")
...
10. chronogram with the penalized likelihood method
